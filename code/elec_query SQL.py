...
llm=ChatOpenAI(model_name="gpt-3.5-turbo",temperature=0,verbose=True,streaming=True)
...
# f.close()
# g.close()
print(db_chain(prompt_template.format(query="Number of candidates fielded by the JD(S)?"))['result'])
